...
class Category extends Component {
  ...
  selectcat(e) {
    ...
    axios
      .post("http://185.154.53.105:1338/api/category", { name: id })
      .then(response => {
        ...
        button.addEventListener("click", e => {
          ...
          axios
            .post("http://185.154.53.105:1338/api/deletecategory", {
        ...
        button.addEventListener("click", e => {
          ...
          button_change.addEventListener("click", e => {
            ...
            axios
              .post("http://185.154.53.105:1338/api/updatecategory", {
  ...
  create_ul(parent, data) {
    ...
    ul.classList.add('togleforulclass');
    ...
    for (var i = 0; i < data.length; i++) {
      ...
      button.addEventListener("click", e => {
        var cat_name = document.getElementById("cat_select").value;
        axios
          .post("http://185.154.53.105:1338/api/deletesubcategory", {
            cat_name: cat_name,
            name: li.id
          })
          .then(response => {
  ...
  addcat() {
    ...
    axios
      .post("http://185.154.53.105:1338/api/addcategory", jsonPost)
      .then(response => {
        this.refresh_sel();
      });
  }
